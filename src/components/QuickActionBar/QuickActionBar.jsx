...
export default function QuickActionBar(props) {
  ...
  return (
    <div className={styles.quickActionBar}>
      <Button onPress={() => setAction("primaryColor")}>
        {quickActions[0].icon}
      </Button>

      <ColorSlider onChange={(event) => console.log(event)} channel="hue" defaultValue="hsl(0, 100%, 50%)">
        <SliderTrack>
          <ColorThumb />
        </SliderTrack>
      </ColorSlider>

      <WheelPicker style={{height: 50, width: 50, color: "white"}}/>
