  ...
  return (
    <Popover.Root>
      <Popover.Trigger asChild>
        <button title={props.layer} className="picker-button" aria-label="Change primary color">
          {props.icon}
        </button>
      </Popover.Trigger>
      <Popover.Portal>
